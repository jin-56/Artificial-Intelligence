...
# Streamlit
st.title("Document Classification Model ")
st.write("This is a simple document classification model working based on BBC news articles.")

import pickle
# Load the model from the file
with open('Document_Classification_Model.pkl', 'rb') as file:
...
#input from user
user_input = st.text_input("Enter Document text for prediction:")
